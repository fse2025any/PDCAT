...
For obtain tuning data (e.g., program `correlation`), you can input command `python InitialTuning.py --log_file=correlation_pdcat.log --source_path=/home/user/polybench-code/datamining/correlation --gcc_path=gcc --flag_path=/home/user/flag.txt --sequences_path=/home/user/inidata.txt --constraints_path=/home/user/constraints.txt`.
